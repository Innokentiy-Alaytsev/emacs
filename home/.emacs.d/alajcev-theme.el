...
(custom-theme-set-faces
 ...
 '(default ((t (:inherit nil :stipple nil :background "gray9" :foreground "moccasin" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 90 :width normal :foundry "unknown" :family "DejaVu Sans Mono")))))

(provide-theme 'alajcev)
