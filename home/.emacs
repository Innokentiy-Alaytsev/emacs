(custom-set-variables
 ...
 '(projectile-cache-file "~/.workspace/projectile.cache")
 '(projectile-enable-caching t)
 '(projectile-known-projects-file "~/.workspace/projectile-bookmarks.eld")
 ...
 '(transient-history-file "~/.workspace/transient/history.el")
 '(transient-levels-file "~/.workspace/transient/levels.el")
 '(transient-values-file "~/.workspace/transient/values.el")
